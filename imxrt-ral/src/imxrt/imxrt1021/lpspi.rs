...
pub use crate::imxrt::peripherals::lpspi_v1::Instance;
pub use crate::imxrt::peripherals::lpspi_v1::{RegisterBlock, ResetValues};
pub use crate::imxrt::peripherals::lpspi_v1::{
