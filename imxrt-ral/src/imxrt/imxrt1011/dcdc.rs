...
pub use crate::imxrt::peripherals::dcdc_v1::Instance;
pub use crate::imxrt::peripherals::dcdc_v1::{RegisterBlock, ResetValues};
pub use crate::imxrt::peripherals::dcdc_v1::{REG0, REG1, REG2, REG3};
