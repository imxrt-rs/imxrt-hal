...
//! FlexSPI
//!
//! Used by: imxrt1015, imxrt1021, imxrt1051, imxrt1052

#[cfg(not(feature = "nosync"))]
pub use crate::imxrt::peripherals::flexspi::Instance;
pub use crate::imxrt::peripherals::flexspi::{RegisterBlock, ResetValues};
pub use crate::imxrt::peripherals::flexspi::{
