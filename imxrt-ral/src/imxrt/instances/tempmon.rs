...
pub use crate::imxrt::peripherals::tempmon::Instance;
pub use crate::imxrt::peripherals::tempmon::{RegisterBlock, ResetValues};
pub use crate::imxrt::peripherals::tempmon::{
