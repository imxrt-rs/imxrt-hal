...
pub use crate::imxrt::peripherals::iomuxc_snvs_gpr::Instance;
pub use crate::imxrt::peripherals::iomuxc_snvs_gpr::{RegisterBlock, ResetValues};
pub use crate::imxrt::peripherals::iomuxc_snvs_gpr::{GPR0, GPR1, GPR2, GPR3};
