...
pub use crate::imxrt::peripherals::nvic_v1::Instance;
pub use crate::imxrt::peripherals::nvic_v1::{RegisterBlock, ResetValues};
pub use crate::imxrt::peripherals::nvic_v1::{
