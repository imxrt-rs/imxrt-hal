...
//!
//! Used by: imxrt1052, imxrt1062, imxrt1064

#[cfg(not(feature = "nosync"))]
pub use crate::imxrt::peripherals::pxp::Instance;
pub use crate::imxrt::peripherals::pxp::{RegisterBlock, ResetValues};
pub use crate::imxrt::peripherals::pxp::{
