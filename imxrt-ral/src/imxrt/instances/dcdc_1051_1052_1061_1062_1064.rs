...
pub use crate::imxrt::peripherals::dcdc_v2::Instance;
pub use crate::imxrt::peripherals::dcdc_v2::{RegisterBlock, ResetValues};
pub use crate::imxrt::peripherals::dcdc_v2::{REG0, REG1, REG2, REG3};
