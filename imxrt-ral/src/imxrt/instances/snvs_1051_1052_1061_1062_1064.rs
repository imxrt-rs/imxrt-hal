...
pub use crate::imxrt::peripherals::snvs_v2::Instance;
pub use crate::imxrt::peripherals::snvs_v2::{
...
pub use crate::imxrt::peripherals::snvs_v2::{RegisterBlock, ResetValues};
