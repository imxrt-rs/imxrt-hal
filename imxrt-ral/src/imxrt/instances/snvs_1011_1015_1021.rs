...
pub use crate::imxrt::peripherals::snvs_v1::Instance;
pub use crate::imxrt::peripherals::snvs_v1::{
...
pub use crate::imxrt::peripherals::snvs_v1::{RegisterBlock, ResetValues};
