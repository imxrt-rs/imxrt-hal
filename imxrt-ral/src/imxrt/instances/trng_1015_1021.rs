...
pub use crate::imxrt::peripherals::trng_v2::Instance;
pub use crate::imxrt::peripherals::trng_v2::{RegisterBlock, ResetValues};
pub use crate::imxrt::peripherals::trng_v2::{
